...
engine = create_engine('sqlite:///userid_search_history_admin.db')
...
if __name__ == "__main__":
    # Add a new user
    add_user('130', 'John Doe', 'johndoe@example.com', False)
    ...
    # Update a user
    update_user('130', name='Jane Doe')
    log_search('130', 'Human Genes')
    # Delete a user
    delete_user('130')
